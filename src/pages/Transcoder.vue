    ...
    <div class="q-gutter-y-md" style="max-width: 100%">
      <q-card>
        <q-tabs
          ...
          narrow-indicator
        >
          <q-tab name="mails" label="TRC1" />
          <q-tab name="alarms" label="TRC2" />
          <q-tab name="movies" label="TRC3" />
        </q-tabs>
        ...
        <q-tab-panels v-model="tab" animated>
          ...
          <q-tab-panel name="alarms">
            <div class="text-h6">Transcoder 2</div>
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
          </q-tab-panel>

          <q-tab-panel name="movies">
            <div class="text-h6">Transcoder 3</div>
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
          </q-tab-panel>
        </q-tab-panels>
      </q-card>
